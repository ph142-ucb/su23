...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(2,
           numericInput("q12", "Quiz 12", value = NA, min = 0, max = 100, step = 1)),
    column(2,
           numericInput("q13", "Quiz 13", value = NA, min = 0, max = 100, step = 1)),
    column(2,
           numericInput("q14", "Quiz 14", value = NA, min = 0, max = 100, step = 1)),
    column(2,
           numericInput("q15", "Quiz 15", value = NA, min = 0, max = 100, step = 1))),
  fluidRow(
    column(2,
           numericInput("q16", "Quiz 16", value = NA, min = 0, max = 100, step = 1)),
    column(2,
           numericInput("q17", "Quiz 17", value = NA, min = 0, max = 100, step = 1)),
    column(2,
           numericInput("q18", "Quiz 18", value = NA, min = 0, max = 100, step = 1)),
    column(2,
           numericInput("q19", "Quiz 19", value = NA, min = 0, max = 100, step = 1)),
    column(2,
           numericInput("q20", "Quiz 20", value = NA, min = 0, max = 100, step = 1))),
  fluidRow(
   column(2,
           numericInput("q21", "Quiz 21", value = NA, min = 0, max = 100, step = 1)),
    column(2,
           numericInput("q22", "Quiz 22", value = NA, min = 0, max = 100, step = 1))),
  fluidRow(
    column(4,
